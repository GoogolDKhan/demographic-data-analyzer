...
def calculate_demographic_data(print_data=True):
    ...
    non_percentage_higher = higher_education[higher_education.salary == ">50K"].size
    higher_education_rich = round(non_percentage_higher / higher_education.size * 100, 1)
    non_percentage_lower = lower_education[lower_education.salary == ">50K"].size
    lower_education_rich = round(non_percentage_lower / lower_education.size * 100, 1)
